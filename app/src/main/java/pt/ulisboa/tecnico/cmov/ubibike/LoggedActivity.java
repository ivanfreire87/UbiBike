...
public class LoggedActivity extends AppCompatActivity implements ConnectionService.Callbacks {
    ...
    public final static String POINTS = "pt.ulisboa.tecnico.cmov.ubibike.INTEGER";
    ...
    public void stations(View view) {
        ...
        final CharSequence[] stations = getAvailableStations();

        new AlertDialog.Builder(this)
                .setTitle("Select a station to book a bike")
    ...
    public CharSequence[]  getAvailableStations(){
        ...
        if (mBound) {
            ...
            Log.d("MainActivity", "DEBUG Sending REQUEST FOR AVAILABLE STATIONS." + sentMessage);
    ...
    public void bookBike(String station){
        if (mBound) {

            String sentMessage = "RESERVE|" + username +"|" + station;

            Log.d("MainActivity", "DEBUG Booking bike." + sentMessage);
            ...
            if (splitMessage[0].equals("OK")) {
                ...
                Toast.makeText(LoggedActivity.this, "Error booking bike.", Toast.LENGTH_SHORT).show();
